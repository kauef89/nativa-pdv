/**
 * helpers.js
 * Funções de lógica de alto nível, como carregamento de dados e gerenciamento de estado da aplicação.
 * Refatorado para usar o estado centralizado e desacoplar do objeto window.
 * ATUALIZAÇÃO (SONDA): Adiciona logs para rastrear a definição da modalidade.
 * ATUALIZAÇÃO (CPT Pagamentos / Restrição): Atualiza 'hydrateStateFromWindow'
 * para carregar 'paymentMethods' e 'paymentRestriction' no estado global.
 */

import { openProductDetails } from '../features/product-sheet/product-sheet-logic.js';
import {
    getMenuData,
    getBairros,
...
import {
    ...
    openSheet,
    closeSheet,
} from './nativa-ui-helpers.js';
import { initFromMenu as initComboWizardFromMenu } from '../features/menu/combo-wizard-handlers.js';
