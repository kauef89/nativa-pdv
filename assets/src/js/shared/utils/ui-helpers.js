// shared/utils/ui-helpers.js

import { init as prepareSocialLogin } from '@apps/consumer/features/auth/login-prompt-handler.js';
import { init as initOnboarding } from '@apps/consumer/features/onboarding/onboarding-handler.js';
