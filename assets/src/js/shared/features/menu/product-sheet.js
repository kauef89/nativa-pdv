// shared/features/menu/product-sheet.js

import { addToCart } from '@core/api/api-service.js';
import {
    showToast,
    showSpinner,
    hideSpinner,
...
import {
    renderProductAddons,
    // CORREÇÃO: Removido 'attachAddonListeners' não utilizado
...
import { handleModalitySheetDisplay } from '@apps/consumer/features/cart/cart-handlers.js';
