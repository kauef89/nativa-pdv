// shared/features/menu/addons/addons-sabor.js

import { formatPrice } from '@utils/formatters.js';
import { showToast } from '@utils/ui-helpers.js';
// CORREÇÃO: Removido import não utilizado 'updateGroupMaxSelectionState'
...
export function getSuggestionIndexesAndUpdateUI(groupId, groupElement) {
    ...
    switch (group.suggestion_mode) {
        case 'defined_list': {
            // CORREÇÃO: Adicionado bloco {} para evitar erro de lexical declaration no switch
