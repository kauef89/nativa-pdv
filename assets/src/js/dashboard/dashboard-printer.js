// src/js/dashboard/dashboard-printer.js

/**
 * Módulo responsável por gerar os layouts de impressão térmicos (80mm).
 * ATUALIZAÇÃO:
 * - Redução global de -1px em todas as fontes (ajuste fino para IBM Plex Mono).
 * - Mantido: Fonte IBM Plex Mono, Checkbox arredondado, Margens de 74mm.
 */
