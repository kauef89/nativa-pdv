// js/dashboard/dashboard-fetch.js
/**
 * Módulo responsável pela busca de dados (inicial e atualizações) para o dashboard.
 * ATUALIZAÇÃO (Fase 3 Pagamentos): Salva o 'payment_methods_map' recebido
 * da API no 'state.allPaymentMethods' durante a carga inicial.
 */

import { state } from './dashboard-state.js';
import * as api from './dashboard-api.js';
import * as filters from './dashboard-filters.js'; // Para carregar filtros
import * as ui from './dashboard-ui.js'; // Para renderizar filtros na carga inicial
