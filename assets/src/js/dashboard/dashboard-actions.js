// js/dashboard/dashboard-actions.js

/**
 * Módulo para lidar com as ações do usuário nos pedidos do dashboard
 * (mudança de status, pagamento, notificação, cópia, etc.).
 * VERSÃO DEBUG (SONDAS + CSS FIX): Adiciona logs e injeta CSS para modais.
 */
...
import { showModal } from '../utils/modal.js'; // Ainda usado para outras ações
import { fetchData } from './dashboard-fetch.js';
import { printKitchenReport, printCourierReport } from './dashboard-printer.js';
