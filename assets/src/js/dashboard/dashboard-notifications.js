// js/dashboard/dashboard-notifications.js
/**
 * Módulo para gerenciar notificações (Push, Áudio, Título da Página)
 * e comunicação via BroadcastChannel para o dashboard.
 */
...
let audioInterval = null; // Removido, som toca apenas uma vez por novo pedido
