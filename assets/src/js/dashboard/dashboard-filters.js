// js/dashboard/dashboard-filters.js
/**
 * Módulo para gerenciar a lógica de filtragem e renderização
 * baseada nos filtros do dashboard.
 */
...
export function saveFiltersToSession(selectors) {
    ...
    if (selectedModalities.includes('all') || selectedModalities.length === 0) {
        ...
        selectedModalities = selectedModalities.filter((m) => m !== 'all');
    }
