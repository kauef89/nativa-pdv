// js/features/address/address-handler.js

/**
 * Controlador Lógico do Wizard de Endereço.
 * Gerencia as 3 etapas, busca de ruas, submissão e PERSISTÊNCIA DE ESTADO.
 * VERSÃO CORRIGIDA (BUSCA): Adiciona .trim() na busca para corrigir falha com espaço automático do teclado mobile.
 */
 ...
 */
export async function init(context = 'general') {
    // Pré-carrega dados
