// js/features/my-favorites/my-favorites-ui.js

/**
 * Módulo de UI para renderizar os cards de favoritos.
 * Criado para a arquitetura de módulos ES6.
 * VERSÃO ATUALIZADA: Adiciona a classe correta ao botão de login do placeholder.
 * ATUALIZAÇÃO (Disponibilidade): Verifica a disponibilidade do item base e dos adicionais
 * e adiciona um indicador visual a cards de favoritos indisponíveis.
 */

import { formatPrice } from '../../utils/nativa-utils.js';
// INÍCIO DA MODIFICAÇÃO DE SEGURANÇA: Importa a função de sanitização.
