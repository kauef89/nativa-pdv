/**
 * Módulo de UI para a página de checkout.
 * Módulo refatorado para ES6.
 * ATUALIZAÇÃO (CPT Pagamentos):
 * - Adiciona a função 'renderPaymentMethods' para criar botões dinamicamente a partir do 'state'.
 * - Implementa a lógica de 'disponibilidade' e 'paymentRestriction' (restrição PIX) na renderização.
 * - Modifica 'updatePaymentMethodInfo' para ler dados dinâmicos ('info_adicional', 'exige_troco') do objeto do método.
 * ATUALIZAÇÃO (MISSÃO 1): Altera o texto do tooltip de restrição de pagamento.
 * ATUALIZAÇÃO (MISSÃO 1.1): Adiciona a classe 'is-unavailable' aos botões desabilitados.
 */

import { formatPrice } from '../../utils/nativa-utils.js';
import { renderCartItemHTML } from '../cart/cart-ui.js';
