/**
 * Módulo de UI para renderizar a ficha (sheet) de recompensas de fidelidade.
 * Refatorado para a arquitetura de módulos ES6.
 */

// CORRIGIDO: A função de formatação de número agora é importada do local correto.
import { formatNumberWithThousandSeparator } from '../../utils/nativa-utils.js';
// IMPORTAÇÃO ADICIONADA: Inclui a função para abrir a ficha de detalhes do produto.
import { openProductDetails } from '../product-sheet/product-sheet-logic.js';
// --- INÍCIO DA MODIFICAÇÃO ---
import { provideFeedbackForDisabledElement } from '../../utils/nativa-ui-helpers.js';
// --- FIM DA MODIFICAÇÃO ---
// A importação abaixo foi removida pois a função não era exportada e não estava em uso.
// import { _formatNumberWithThousandSeparator } from './my-account-ui.js';
