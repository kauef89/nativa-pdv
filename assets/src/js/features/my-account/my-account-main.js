// js/features/my-account/my-account-main.js
...
import { init as initAddressHandler } from '../address/address-handler.js';
...
import { init as prepareSocialLogin } from '../login/login-prompt-handler.js';
