// apps/consumer/features/onboarding/onboarding-handler.js

import * as api from '@core/api/api-service.js';
import { state } from '@core/state/global-state.js';
import { handleOpenAddressForm } from '@shared/features/address/address-handler.js';
import {
    closeSheet,
    hideSpinner,
    openSheet,
...
function saveState() {
    ...
    try {
        ...
        // Ignora erros de parse ou dados corrompidos
    }
...
// CORREÇÃO: Removido parâmetro 'needsDob' não utilizado
...
async function handleNextClick() {
    const nextBtn = document.getElementById('nativa-onboarding-next-btn');
    // CORREÇÃO: Removida declaração de 'backBtn' não utilizada
