// apps/consumer/features/cart/cart-ui.js
...
// --- CORREÇÃO ESLINT: Removido argumento 'bairros' não utilizado ---
...
// --- CORREÇÃO ESLINT: Removidos argumentos 'canCheckout' e 'serviceStatus' não utilizados ---
    ...
    if (selectedModality === 'delivery') {
        if (isLoggedIn) {
            ...
            if (userAddressContainer) {
                ...
                _renderUserAddress(addresses); // Re-renderiza a lista de endereços
